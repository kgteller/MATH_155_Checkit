class Generator(BaseGenerator):
    def data(self):
        ...
        if ch_1==1:
            ...
            dep_2=round((zscore_2*(SD_1/10)+mean_1),2)
            answer_2=round(ND.cum_distribution_function((dep_2 - mean_1)/(SD_1/10)),4)
            if ind_2=="NASDAQ":
                dep_2=round((zscore_2*(SD_2/10)+mean_2),2)
        ...
        ind_4="NASDAQ"
        dep_3=round((zscore_3*(SD_2/10)+mean_2),2)
        dep_4=round((zscore_4*(SD_2/10)+mean_2),2)
        ...
        if ind_1=="NASDAQ":
            ind_4="NYSE"
            dep_3=round((zscore_3*(SD_1/10)+mean_1),2)
            dep_4=round((zscore_4*(SD_1/10)+mean_1),2)
